...
import { WorkHolidayVisaRoutingModule } from './workHolidayVisa-routing.module';
...
@NgModule({
  declarations: [
    //WorkHolidayVisaRequirementsComponent,
    WorkHolidayVisaFormComponent,
    //WorkHolidayVisaDeclarationComponent,
    //WorkHolidayVisaDocumentsComponent,
    //DocInputComponent,
    //WorkHolidayVisaAcknowledgementComponent
  ],
  imports: [
    CommonModule,
    SharedModule,
    WorkHolidayVisaRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class WorkHolidayVisaModule { }
