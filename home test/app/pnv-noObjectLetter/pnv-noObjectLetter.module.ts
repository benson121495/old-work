...
import { pnvNoObjectLetterRoutingModule } from './pnv-noObjectLetter-routing.module';
...
@NgModule({
  declarations: [
    pnvNoObjectLetterAFormComponent,
    pnvNoObjectLetterBFormComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvNoObjectLetterRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvNoObjectLetterModule { }
