...
@Component({
  selector: 'pnvNoObjectLetterB-form',
  templateUrl: './formB.component.html',
  styleUrls: ['./formB.component.css']
})
export class pnvNoObjectLetterBFormComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  private intializeForm() {
    ...
    this.fillForm = this.formBuilder.group({
      employerName: new FormControl(this.pnvNoObjectLetterModel.employerName),
      businessNature: new FormControl(this.pnvNoObjectLetterModel.businessNature),
      companyAddress: new FormControl(this.pnvNoObjectLetterModel.companyAddress),
      post: new FormControl(this.pnvNoObjectLetterModel.post),
      internshipPeriod: new FormControl(this.pnvNoObjectLetterModel.internshipPeriod),
      roomFlat: new FormControl(this.pnvNoObjectLetterModel.roomFlat),
      floor: new FormControl(this.pnvNoObjectLetterModel.floor),
      block: new FormControl(this.pnvNoObjectLetterModel.block),
      building: new FormControl(this.pnvNoObjectLetterModel.building),
      estate: new FormControl(this.pnvNoObjectLetterModel.estate),
      street: new FormControl(this.pnvNoObjectLetterModel.street),
  ...
  private resetModel() {
    this.pnvNoObjectLetterModel.employerName = '';
    this.pnvNoObjectLetterModel.businessNature = '';
    this.pnvNoObjectLetterModel.companyAddress = '';
    this.pnvNoObjectLetterModel.post = '';
    this.pnvNoObjectLetterModel.internshipPeriod = '';
