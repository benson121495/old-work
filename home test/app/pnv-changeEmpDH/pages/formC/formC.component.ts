...
export class PnvChangeEmpDHCFormComponent implements OnInit, AfterViewInit, OnDestroy {
...
*/
  ...
  private intializeForm() {
    this.fillForm = this.formBuilder.group({
      /**part1 */
      justification: new FormControl(this.pnvChangeEmpDHModel.justification)
