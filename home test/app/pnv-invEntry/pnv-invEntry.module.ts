...
import { PnvInvEntryRoutingModule } from './pnv-invEntry-routing.module';
...
@NgModule({
  ...
  PnvInvEntryAFormComponent,
  PnvInvEntryBFormComponent
...
export class PnvInvEntryModule { }
