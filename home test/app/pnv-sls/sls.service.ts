...
export class SlsService {
  ...
  get SlsModel(): Sls {
    return this.slsModel;
  }

  setSlsModel(slsModel: Sls) {
    this.slsModel = slsModel;
  }
  ...
  saveData(slsModel, partURL, language): Observable<any> {
    return this.http.post<any>(this.baseurl + partURL + '?lang=' + language, JSON.stringify(slsModel), this.httpOptions);
  }

  saveARN(slsModel, partURL, language): Observable<any> {
    return this.http.post<any>(this.baseurl + partURL + '?lang=' + language, JSON.stringify(slsModel), this.httpOptions);
  }
  ...
  getPdfImage(slsModel, pdfName, ern): Observable<any> {
    return this.http.post<any>(this.baseurl + 'getwebform?pdfType=' + pdfName + '&ern=' + ern, slsModel);
  }
