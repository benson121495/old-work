...
export class CoeService {
  ...
  get CoeModel(): Coe {
    return this.coeModel;
  }

  setCoeModel(coeModel: Coe) {
    this.coeModel = coeModel;
  }
  ...
  saveData(CoeModel, partURL, language): Observable<any> {
    return this.http.post<any>(this.baseurl + partURL + '?lang=' + language, JSON.stringify(CoeModel), this.httpOptions);
  }

  saveARN(CoeModel, partURL, language): Observable<any> {
    return this.http.post<any>(this.baseurl + partURL + '?lang=' + language, JSON.stringify(CoeModel), this.httpOptions);
  }
  ...
  getPdfImage(coeModel, pdfName, ern): Observable<any> {
    return this.http.post<any>(this.baseurl + 'getwebform?pdfType=' + pdfName + '&ern=' + ern, coeModel);
  }
