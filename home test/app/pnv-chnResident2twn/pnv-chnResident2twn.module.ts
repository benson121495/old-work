...
import { PnvChnResident2TwnRoutingModule } from './pnv-chnResident2twn-routing.module';
...
@NgModule({
  ...
  PnvChnResident2TwnFormComponent
  ...
  imports: [
    CommonModule,
    SharedModule,
    PnvChnResident2TwnRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class PnvChnResident2TwnModule { }
