...
import { pnvExtendTechtasRoutingModule } from './pnv-extendTechtas-routing.module';
...
@NgModule({
  declarations: [
    pnvExtendTechtasADeclarationComponent,
    pnvExtendTechtasBDeclarationComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvExtendTechtasRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvExtendTechtasModule { }
