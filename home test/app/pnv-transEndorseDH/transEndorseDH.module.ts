...
import { TransEndorseDHRoutingModule } from './transEndorseDH-routing.module';
...
@NgModule({
  declarations: [
    //TransEndorseDHRequirementsComponent,
    TransEndorseDHFormComponent,
    //TransEndorseDHDeclarationComponent,
    //TransEndorseDHDocumentsComponent,
    //DocInputComponent,
    //TransEndorseDHAcknowledgementComponent
  ],
  imports: [
    CommonModule,
    SharedModule,
    TransEndorseDHRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class TransEndorseDHModule { }
