...
@Component({
  selector: 'fdhes-declarationA',
  templateUrl: './declarationA.component.html',
  styleUrls: ['./declarationA.component.css']
})
export class FdhesDeclarationAComponent implements OnInit {
  fillForm: FormGroup;
  stepNumber = 3;
  age: Number;
  fdhesModel: Fdhes;
  ...
  ngOnInit() {
    ...
    this.fillForm = this.formBuilder.group({
      ...
      undertakingA: new FormControl(this.fdhesModel.undertakingA),
      agreementA: new FormControl(this.fdhesModel.agreementA)
  ...
  backClicked() {
    ...
    this.router.navigate(['../formA'], { relativeTo: this.activatedRoute });
  }
