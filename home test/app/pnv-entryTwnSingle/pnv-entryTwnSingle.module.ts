...
import { PnvEntryTwnSingleRoutingModule } from './pnv-entryTwnSingle-routing.module';
...
import { PnvEntryTwnSingleFormComponent } from './pages/form/form.component';
...
@NgModule({
  ...
  PnvEntryTwnSingleFormComponent
  ...
  imports: [
    CommonModule,
    SharedModule,
    PnvEntryTwnSingleRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class PnvEntryTwnSingleModule { }
