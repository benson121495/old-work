import { PnvTermEmpService } from 'src/app/pnv-termEmp/pnv-termEmp.service';
import { PnvTermEmp } from 'src/app/pnv-termEmp/pnv-termEmp.model';
...
@Component({
  selector: 'pnv-termEmp-form',
  templateUrl: './form.component.html',
  styleUrls: ['./form.component.css']
})
export class PnvTermEmpFormComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    private pnvTermEmpService: PnvTermEmpService,
  ...
  ngOnInit() {
    ...
    this.pnvTermEmpModel = this.pnvTermEmpService.PnvTermEmpModel;
