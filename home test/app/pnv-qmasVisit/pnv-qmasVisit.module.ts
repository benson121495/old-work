...
import { pnvQmasVisitRoutingModule } from './pnv-qmasVisit-routing.module';
...
import { pnvQmasVisitFormComponent } from './pages/form/form.component';
...
@NgModule({
  declarations: [
    pnvQmasVisitFormComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvQmasVisitRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvQmasVisitModule { }
