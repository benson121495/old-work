...
import { EntryTwnMultiRoutingModule } from './entryTwnMulti-routing.module';
...
//import { EntryTwnMultiComponent } from './component/doc-input/doc-input.component';
//import { EntryTwnMultiAcknowledgementComponent } from './pages/acknowledgement/acknowledgement.component';

@NgModule({
  declarations: [
    //EntryTwnMultiRequirementsComponent,
    EntryTwnMultiFormComponent,
    //EntryTwnMultiDeclarationComponent,
    //EntryTwnMultiDocumentsComponent,
    //DocInputComponent,
    //EntryTwnMultiAcknowledgementComponent
  ],
  imports: [
    CommonModule,
    SharedModule,
    EntryTwnMultiRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class EntryTwnMultiModule { }
