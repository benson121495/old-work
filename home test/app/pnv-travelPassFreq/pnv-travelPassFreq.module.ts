...
import { pnvTravelPassFreqRoutingModule } from './pnv-travelPassFreq-routing.module';
...
@NgModule({
  declarations: [
    pnvTravelPassFreqFormComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvTravelPassFreqRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvTravelPassFreqModule { }
