...
import { CiesEntryRoutingModule } from './ciesEntry-routing.module';
...
//import { CiesEntryComponent } from './component/doc-input/doc-input.component';
//import { CiesEntryAcknowledgementComponent } from './pages/acknowledgement/acknowledgement.component';

@NgModule({
  declarations: [
    //CiesEntryRequirementsComponent,
    CiesEntryFormComponent,
    //CiesEntryDeclarationComponent,
    //CiesEntryDocumentsComponent,
    //DocInputComponent,
    //CiesEntryAcknowledgementComponent
  ],
  imports: [
    CommonModule,
    SharedModule,
    CiesEntryRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
