...
import { pnvVisaHkStudyRoutingModule } from './pnv-visaHkStudy-routing.module';
...
@NgModule({
  declarations: [
    pnvVisaHkStudyCFormComponent,
    pnvVisaHkStudyDFormComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvVisaHkStudyRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvVisaHkStudyModule { }
