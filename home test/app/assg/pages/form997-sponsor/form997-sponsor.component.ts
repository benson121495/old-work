...
@Component({
  selector: 'assg-form-997-sponsor',
  templateUrl: './form997-sponsor.component.html',
  styleUrls: ['./form997-sponsor.component.css']
})
export class AssgForm997SponsorComponent implements OnInit {
  assgModel: Assg
  stepNumber = 3;
  fillForm: FormGroup;
  ...
  onSubmit() {
    this.router.navigate(['../declaration-form997-sponsor'], {
