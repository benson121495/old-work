...
@Component({
  selector: 'assg-form1017',
  templateUrl: './form1017.component.html',
  styleUrls: ['./form1017.component.css']
})
export class AssgForm1017Component implements OnInit, AfterViewInit, OnDestroy {
