...
import { pnvChangeAddrRoutingModule } from './pnv-changeAddr-routing.module';
...
import { pnvChangeAddrFormComponent } from './pages/form/form.component';
...
@NgModule({
  declarations: [
    pnvChangeAddrFormComponent,
  ],
  imports: [
    CommonModule,
    SharedModule,
    pnvChangeAddrRoutingModule,
    TextMaskModule,
    FormsModule,
    TranslateModule,
    ReactiveFormsModule,
...
export class pnvChangeAddrModule { }
